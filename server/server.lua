...
function getOrGeneratePhoneNumber (sourcePlayer, identifier, cb)
    ...
    if myPhoneNumber == '0' or myPhoneNumber == nil then
        ...
        until id == nil
        MySQL.Async.insert("UPDATE player_account SET phone_number = @myPhoneNumber WHERE player_identifier = @identifier", { 
...
function getMessages(identifier)
    local result = MySQL.Sync.fetchAll("SELECT phone_messages.* FROM phone_messages LEFT JOIN player_account ON player_account.player_identifier = @identifier WHERE phone_messages.receiver = player_account.phone_number", {
         ['@identifier'] = identifier
    })
    return result
